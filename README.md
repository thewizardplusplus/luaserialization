...
- serialization to JSON:
  ...
  - `json.save_to_json()` function &mdash; this function serializes data into JSON and saves it via the passed callback;
  ...
  - `json.load_from_json()` function &mdash; this function loads JSON via the passed callback and parses it.
