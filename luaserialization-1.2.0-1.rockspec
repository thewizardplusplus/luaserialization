...
build = {
  ...
  modules = {
    ...
    ["luaserialization.nameable"] = "nameable.lua",
    ["luaserialization.nameable_test"] = "nameable_test.lua",
    ...
    ["luaserialization.filesystem.filesystem"] = "filesystem/filesystem.lua",
    ["luaserialization.filesystem.filesystem_test"] = "filesystem/filesystem_test.lua",
    ["luaserialization.filesystem.fileforstdlibrary"] = "filesystem/fileforstdlibrary.lua",
    ["luaserialization.filesystem.fileforstdlibrary_test"] = "filesystem/fileforstdlibrary_test.lua",
    ["luaserialization.filesystem.filesystemforstdlibrary"] = "filesystem/filesystemforstdlibrary.lua",
    ["luaserialization.filesystem.filesystemforstdlibrary_test"] = "filesystem/filesystemforstdlibrary_test.lua",
    ["luaserialization.filesystem.fileforloveframework"] = "filesystem/fileforloveframework.lua",
    ["luaserialization.filesystem.filesystemforloveframework"] = "filesystem/filesystemforloveframework.lua",
